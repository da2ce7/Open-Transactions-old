...
public:
	...
	// from strOutput.
	//
	EXPORT	static bool DearmorAndTrim(const OTString & strInput, OTString & strOutput, OTString & strFirstLine);
	...
	//
	EXPORT	static bool AddBookendsAroundContent( OTString & strOutput,
