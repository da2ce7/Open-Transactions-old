...
class Storable(_object):
    ...
    __swig_getmethods__["ot_dynamic_cast_box"] = lambda x: _otapi.Storable_ot_dynamic_cast_box
    if _newclass:ot_dynamic_cast_box = staticmethod(_otapi.Storable_ot_dynamic_cast_box)
...
def Storable_ot_dynamic_cast_box(*args):
  return _otapi.Storable_ot_dynamic_cast_box(*args)
Storable_ot_dynamic_cast_box = _otapi.Storable_ot_dynamic_cast_box
