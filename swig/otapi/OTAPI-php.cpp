...
ZEND_NAMED_FUNCTION(_wrap_Storable_ot_dynamic_cast_box) {
  OTDB::Storable *arg1 = (OTDB::Storable *) 0 ;
  zval **args[1];
  OTDB::Storable *result = 0 ;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_OTDB__Storable, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Storable_ot_dynamic_cast_box. Expected SWIGTYPE_p_OTDB__Storable");
    }
  }
...
static zend_function_entry otapi_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(storable_ot_dynamic_cast_box,_wrap_Storable_ot_dynamic_cast_box,NULL)
