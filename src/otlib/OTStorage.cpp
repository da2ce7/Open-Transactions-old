...
#define IMPLEMENT_GET_ADD_REMOVE(scope, name) \
	...
	{ PointerTo##name theP = list_##name##s.at(nIndex); return theP.get(); } return nullptr; } \
	\
...
\
	...
	/*
	 ...
	 bool ParseFromString(const std::string& data); parses a message from the given string.
